...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(14), __webpack_require__(48).setImmediate))
...
var sort_1 = __webpack_require__(55);
var dataproxy_1 = __webpack_require__(10);
var helpers_1 = __webpack_require__(8);
var types_1 = __webpack_require__(7);
var core_1 = __webpack_require__(1);
...
var XMLDriver_1 = __webpack_require__(53);
exports.dataDrivers = {
        ...
        return dom_1.el(".dhx_" + rowName + "-row", { style: { height: rowHeight } }, row.map(function (cell, i) {
            ...
            if (!cell.content) {
                if (!cell.align || cell.align === "center") {
                    ...
                    css += " dhx_grid-header-cell--align_" + (cell.align === "right" ? "right" : "left") + " ";
                }
            }
...
function getSpans(config, rowsConfig) {
    ...
    return rows.map(function (row, i) {
        ...
        return dom_1.el(".dhx_span-row", {
            ...
            if (!cell.content) {
                if (!cell.align && cell.colspan) {
                    css += " dhx_grid-header-cell--align_left";
                }
                else if (!cell.align || cell.align === "center") {
                    css += " dhx_grid-header-cell--align_" + (col.type === "number" ? "right" : "left") + " ";
                }
                else {
                    css += " dhx_grid-header-cell--align_" + (cell.align === "right" ? "right" : "left") + " ";
                }
...
function getFixedRows(config, rowsConfig) {
    ...
    if (rowsConfig.name === "footer" && !rowsConfig.sticky) {
        fixedCols =
            config.leftSplit >= 0 &&
                getRows(__assign(__assign({}, config), { currentColumns: config.columns.filter(function (col) { return !col.hidden; }).slice(0, config.leftSplit), $positions: __assign(__assign({}, config.$positions), { xStart: 0, xEnd: config.leftSplit }) }), rowsConfig);
    }
    var styles = (_a = {
            position: "sticky"
        },
...
// HELPERS
var CssManager_1 = __webpack_require__(20);
...
// WIDGETS
var Grid_1 = __webpack_require__(61);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(14), __webpack_require__(50)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var xml_1 = __webpack_require__(54);
...
Object.defineProperty(exports, "__esModule", { value: true });
var html_1 = __webpack_require__(2);
var CollectionStore_1 = __webpack_require__(58);
var types_1 = __webpack_require__(7);
var helpers_1 = __webpack_require__(8);
...
var ts_data_1 = __webpack_require__(5);
var Exporter_1 = __webpack_require__(62);
var data_1 = __webpack_require__(25);
var main_1 = __webpack_require__(9);
var Selection_1 = __webpack_require__(63);
var KeyManager_1 = __webpack_require__(64);
var types_1 = __webpack_require__(3);
var render_1 = __webpack_require__(67);
var core_1 = __webpack_require__(1);
var ts_calendar_1 = __webpack_require__(28);
var content_1 = __webpack_require__(97);
var columnsResizer_1 = __webpack_require__(98);
...
var keys_1 = __webpack_require__(66);
var html_1 = __webpack_require__(2);
var KeyManager = /** @class */ (function () {
...
var FixedCols_1 = __webpack_require__(96);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(6);
var ts_timepicker_1 = __webpack_require__(73);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(29);
var ts_slider_1 = __webpack_require__(78);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cell_1 = __webpack_require__(76);
...
var view_1 = __webpack_require__(6);
var types_1 = __webpack_require__(13);
var helpers_1 = __webpack_require__(77);
var events_1 = __webpack_require__(4);
var CssManager_1 = __webpack_require__(20);
...
var helper_1 = __webpack_require__(32);
...
var helper_2 = __webpack_require__(32);
...
function getFixedColsHeader(renderConfig, layout) {
    ...
    var columns = renderConfig.columns
        .filter(function (col) { return !col.hidden; })
        .slice(0, renderConfig.leftSplit - splitHidden);
    var width = 0;
    for (var _i = 0, columns_1 = columns; _i < columns_1.length; _i++) {
        var col = columns_1[_i];
        width += col.$width;
...
function getFixedCols(renderConfig, layout) {
    ...
    return dom_1.el(".dhx_grid-fixed-cols-wrap", {
        ...
        dom_1.el(".dhx_grid-fixed-cols", __assign({ style: {
                ...
                height: renderConfig.$totalHeight,
                position: "absolute",
            }, _flags: dom_1.KEYED_LIST }, Cells_1.getHandlers(pos.yStart, pos.xStart, renderConfig)), __spreadArrays([spans && dom_1.el(".dhx_span-spans", spans)], fixedCols)),
